...
@Component({
  selector: 'team13-table-player4',
  templateUrl: './table-player4.component.html',
  styleUrls: ['./table-player4.component.scss']
})
export class TablePlayer4Component implements OnInit {
  player_image: string;
  player_dead: string;
  gibbet: string;
  player_name: string;
  ...
  ngOnInit() {
    if (this.eventEmitterService.TablesubsVarpl4==undefined){
      this.eventEmitterService.TablesubsVarpl4 = this.eventEmitterService.    
      invokeTable_functions_player4.subscribe((data) => {
