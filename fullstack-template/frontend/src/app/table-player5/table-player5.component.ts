...
@Component({
  selector: 'team13-table-player5',
  templateUrl: './table-player5.component.html',
  styleUrls: ['./table-player5.component.scss']
})
export class TablePlayer5Component implements OnInit {
  player_image: string;
  player_dead: string;
  player_mayor: string;
  gibbet: string;
