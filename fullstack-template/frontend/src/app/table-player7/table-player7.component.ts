...
@Component({
  selector: 'team13-table-player7',
  templateUrl: './table-player7.component.html',
  styleUrls: ['./table-player7.component.scss']
})
export class TablePlayer7Component implements OnInit {
  player_image: string;
  player_mayor: string;
  player_dead: string;
  gibbet: string;
  ...
  ngOnInit() {
    if (this.eventEmitterService.TablesubsVarpl7==undefined){
      this.eventEmitterService.TablesubsVarpl7 = this.eventEmitterService.    
      invokeTable_functions_player7.subscribe((data) => {
