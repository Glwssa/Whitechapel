...
export class RoleInfoComponent implements OnInit {
  ...
  initInfo(){
      ...
      if (this.role == "JESTER"){this.info = "AS THE JESTER, YOU PLAY THE ROLE OF THE WILDCARD. YOUR ABILITY, NIGHTWALK, ALLOWS YOU TO APPEAR AS 'NOT AT HOME' TO ANY INVESTIGATION. YOUR GOAL IS TO GET HANGED BY THE OTHER PLAYERS THROUGH VOTING." }
